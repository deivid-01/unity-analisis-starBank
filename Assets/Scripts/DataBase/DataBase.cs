...
public class DataBase
{
    ...
    #region CRUD   
    public T FindDocByIdNumber<T> ( string nameCollection , string ID ) => db.GetCollection<T> ( nameCollection ).Find ( Builders<T>.Filter.Eq ( "ID" , ID )).First ();
    ...
    /*
    public T FindDocByIdNumber<T> ( string nameCollection , int idNumber ) {

        var collection=db.GetCollection<T>(nameCollection);
        var filter = Builders<T>.Filter.Eq("IdNumber",idNumber);
